control c_stats_five_t(inout header_t hdr, inout ingress_metadata_t ig_md) {
	...
	action rshift_cov_0() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod;
	}

	action rshift_cov_1() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 1;
	}

	action rshift_cov_2() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 2;
	}

	action rshift_cov_3() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 3;
	}

	action rshift_cov_4() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 4;
	}

	action rshift_cov_5() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 5;
	}

	action rshift_cov_6() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 6;
	}

	action rshift_cov_7() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 7;
	}

	action rshift_cov_8() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 8;
	}

	action rshift_cov_9() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 9;
	}

	action rshift_cov_10() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 10;
	}

	action rshift_cov_11() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 11;
	}

	action rshift_cov_12() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 12;
	}

	action rshift_cov_13() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 13;
	}

	action rshift_cov_14() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 14;
	}

	action rshift_cov_15() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 15;
	}

	action rshift_cov_16() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 16;
	}

	action rshift_cov_17() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 17;
	}

	action rshift_cov_18() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 18;
	}

	action rshift_cov_19() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 19;
	}

	action rshift_cov_20() {
		hdr.peregrine.five_t_cov = ig_md.stats_five_t.sum_res_prod >> 20;
	}
