control c_stats_mac_ip_src_a(inout header_t hdr, inout ingress_metadata_a_t ig_md) {
    ...
    action pkt_cnt_incr() {
        ig_md.stats_mac_ip_src.pkt_cnt_0 = ract_pkt_cnt_incr.execute(ig_md.hash.mac_ip_src);
    }
