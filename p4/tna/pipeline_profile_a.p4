...
control SwitchIngress_a(
    ...
    RegisterAction<decay_cntr, bit<16>, bit<16>>(reg_decay_cntr) ract_decay_cntr_check = {
    ...
    RegisterAction<_, bit<16>, bit<1>>(reg_pkt_cnt_epoch) ract_pkt_cnt_epoch = {
    ...
    RegisterAction<_, bit<16>, bit<32>>(reg_pkt_len_squared) ract_pkt_len_squared_calc = {
    ...
    action set_peregrine_ip_src_a() {
        ...
        /* hdr.peregrine.ip_src_ts_diff = ig_md.stats_ip_src.ts_diff; */
    }
