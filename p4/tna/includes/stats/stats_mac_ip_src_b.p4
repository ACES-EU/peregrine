control c_stats_mac_ip_src_b(inout header_t hdr, inout ingress_metadata_b_t ig_md) {
    ...
    RegisterAction<_, bit<16>, bit<32>>(reg_mac_ip_src_mean_squared) ract_mean_squared_calc = {
    ...
    RegisterAction<_, bit<16>, bit<32>>(reg_mac_ip_src_std_dev) ract_std_dev_calc = {
        void apply(inout bit<32> value, out bit<32> result) {
