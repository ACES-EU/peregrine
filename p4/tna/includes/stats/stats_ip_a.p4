control c_stats_ip_a(inout header_t hdr, inout ingress_metadata_a_t ig_md) {
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_ip_cnt_0) ract_pkt_cnt_0_incr = {
		void apply(inout bit<32> value, out bit<32> result) {
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_ip_cnt_1) ract_pkt_cnt_1_incr = {
		void apply(inout bit<32> value) {
			value = ig_md.stats_ip.pkt_cnt_0;
		}
	};

	RegisterAction<_, bit<16>, bit<32>>(reg_ip_cnt_1) ract_pkt_cnt_1_read = {
		void apply(inout bit<32> value, out bit<32> result) {
			value = value;
			result = value;
		}
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_ip_len) ract_pkt_len_incr = {
		void apply(inout bit<32> value, out bit<32> result) {
			if (ig_md.stats_ip.decay_check == 0) {
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_ip_ss_1) ract_ss_1_incr = {
		void apply(inout bit<32> value) {
			value = ig_md.stats_ip.ss_0;
		}
	};

	RegisterAction<_, bit<16>, bit<32>>(reg_ip_ss_1) ract_ss_1_read = {
		void apply(inout bit<32> value, out bit<32> result) {
			value = value;
			result = value;
		}
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_ip_mean) ract_mean_0_write = {
		void apply(inout bit<32> value) {
			value = ig_md.stats_ip.mean_0;
		}
	};

	RegisterAction<_, bit<16>, bit<32>>(reg_ip_mean) ract_mean_1_read = {
		void apply(inout bit<32> value, out bit<32> result) {
			value = value;
			result = value;
		}
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_ip_res_check) ract_res_check = {
	...
	RegisterAction<res_current, bit<16>, bit<32>>(reg_ip_res) ract_res_read = {
	...
	RegisterAction<res_current, bit<16>, bit<32>>(reg_ip_res) ract_res_update = {
		void apply(inout res_current res, out bit<32> result) {
