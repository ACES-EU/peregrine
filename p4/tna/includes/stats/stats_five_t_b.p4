control c_stats_five_t_b(inout header_t hdr, inout ingress_metadata_b_t ig_md) {
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_five_t_mean_squared_0) ract_mean_squared_0_calc = {
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_five_t_mean_squared_1) ract_mean_squared_1_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_five_t_std_dev_0) ract_std_dev_0_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_five_t_std_dev_1) ract_std_dev_1_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_five_t_magnitude) ract_magnitude_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_five_t_variance_squared_0) ract_variance_squared_0_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_five_t_variance_squared_1) ract_variance_squared_1_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_five_t_radius) ract_radius_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
