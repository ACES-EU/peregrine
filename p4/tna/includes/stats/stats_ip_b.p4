control c_stats_ip_b(inout header_t hdr, inout ingress_metadata_b_t ig_md) {
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_ip_mean_squared_0) ract_mean_squared_0_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
			value = square_mean_0.execute(hdr.peregrine.ip_mean_0);
			result = value;
		}
	};

	MathUnit<bit<32>>(MathOp_t.SQR, 1) square_mean_1;
	RegisterAction<_, bit<16>, bit<32>>(reg_ip_mean_squared_1) ract_mean_squared_1_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_ip_std_dev_0) ract_std_dev_0_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_ip_std_dev_1) ract_std_dev_1_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_ip_magnitude) ract_magnitude_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_ip_variance_squared_0) ract_variance_squared_0_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_ip_variance_squared_1) ract_variance_squared_1_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
	...
	RegisterAction<_, bit<16>, bit<32>>(reg_ip_radius) ract_radius_calc = {
		void apply(inout bit<32> value, out bit<32> result) {
	...
	action rshift_mean_ss_0_0() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0;
	}

	action rshift_mean_ss_0_1() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 1;
	}

	action rshift_mean_ss_0_2() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 2;
	}

	action rshift_mean_ss_0_3() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 3;
	}

	action rshift_mean_ss_0_4() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 4;
	}

	action rshift_mean_ss_0_5() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 5;
	}

	action rshift_mean_ss_0_6() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 6;
	}

	action rshift_mean_ss_0_7() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 7;
	}

	action rshift_mean_ss_0_8() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 8;
	}

	action rshift_mean_ss_0_9() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 9;
	}

	action rshift_mean_ss_0_10() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 10;
	}

	action rshift_mean_ss_0_11() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 11;
	}

	action rshift_mean_ss_0_12() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 12;
	}

	action rshift_mean_ss_0_13() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 13;
	}

	action rshift_mean_ss_0_14() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 14;
	}

	action rshift_mean_ss_0_15() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 15;
	}

	action rshift_mean_ss_0_16() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 16;
	}

	action rshift_mean_ss_0_17() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 17;
	}

	action rshift_mean_ss_0_18() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 18;
	}

	action rshift_mean_ss_0_19() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 19;
	}

	action rshift_mean_ss_0_20() {
		ig_md.stats_ip.mean_ss_0 = hdr.peregrine.ip_ss_0 >> 20;
	}

	action rshift_mean_ss_1_0() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1;
	}

	action rshift_mean_ss_1_1() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 1;
	}

	action rshift_mean_ss_1_2() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 2;
	}

	action rshift_mean_ss_1_3() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 3;
	}

	action rshift_mean_ss_1_4() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 4;
	}

	action rshift_mean_ss_1_5() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 5;
	}

	action rshift_mean_ss_1_6() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 6;
	}

	action rshift_mean_ss_1_7() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 7;
	}

	action rshift_mean_ss_1_8() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 8;
	}

	action rshift_mean_ss_1_9() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 9;
	}

	action rshift_mean_ss_1_10() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 10;
	}

	action rshift_mean_ss_1_11() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 11;
	}

	action rshift_mean_ss_1_12() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 12;
	}

	action rshift_mean_ss_1_13() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 13;
	}

	action rshift_mean_ss_1_14() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 14;
	}

	action rshift_mean_ss_1_15() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 15;
	}

	action rshift_mean_ss_1_16() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 16;
	}

	action rshift_mean_ss_1_17() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 17;
	}

	action rshift_mean_ss_1_18() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 18;
	}

	action rshift_mean_ss_1_19() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 19;
	}

	action rshift_mean_ss_1_20() {
		ig_md.stats_ip.mean_ss_1 = hdr.peregrine.ip_ss_1 >> 20;
	}

	action std_dev_0_calc() {
		hdr.peregrine.ip_std_dev_0 = ract_std_dev_0_calc.execute(0);
	}
	...
	action rshift_cov_0() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov;
	}

	action rshift_cov_1() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 1;
	}

	action rshift_cov_2() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 2;
	}

	action rshift_cov_3() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 3;
	}

	action rshift_cov_4() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 4;
	}

	action rshift_cov_5() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 5;
	}

	action rshift_cov_6() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 6;
	}

	action rshift_cov_7() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 7;
	}

	action rshift_cov_8() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 8;
	}

	action rshift_cov_9() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 9;
	}

	action rshift_cov_10() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 10;
	}

	action rshift_cov_11() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 11;
	}

	action rshift_cov_12() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 12;
	}

	action rshift_cov_13() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 13;
	}

	action rshift_cov_14() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 14;
	}

	action rshift_cov_15() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 15;
	}

	action rshift_cov_16() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 16;
	}

	action rshift_cov_17() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 17;
	}

	action rshift_cov_18() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 18;
	}

	action rshift_cov_19() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 19;
	}

	action rshift_cov_20() {
		ig_md.stats_ip.cov = hdr.peregrine.ip_sum_res_prod_cov >> 20;
	}

	action lshift_std_dev_prod_0() {
		ig_md.stats_ip.std_dev_prod = hdr.peregrine.ip_std_dev_0;
	}

	action lshift_std_dev_prod_1() {
		ig_md.stats_ip.std_dev_prod = hdr.peregrine.ip_std_dev_0 << 1;
	}

	action lshift_std_dev_prod_2() {
		ig_md.stats_ip.std_dev_prod = hdr.peregrine.ip_std_dev_0 << 2;
	}

	action lshift_std_dev_prod_3() {
		ig_md.stats_ip.std_dev_prod = hdr.peregrine.ip_std_dev_0 << 3;
	}

	action lshift_std_dev_prod_4() {
		ig_md.stats_ip.std_dev_prod = hdr.peregrine.ip_std_dev_0 << 4;
	}

	action lshift_std_dev_prod_5() {
		ig_md.stats_ip.std_dev_prod = hdr.peregrine.ip_std_dev_0 << 5;
	}

	action lshift_std_dev_prod_6() {
		ig_md.stats_ip.std_dev_prod = hdr.peregrine.ip_std_dev_0 << 6;
	}

	action lshift_std_dev_prod_7() {
		ig_md.stats_ip.std_dev_prod = hdr.peregrine.ip_std_dev_0 << 7;
	}

	action lshift_std_dev_prod_8() {
		ig_md.stats_ip.std_dev_prod = hdr.peregrine.ip_std_dev_0 << 8;
	}

	action lshift_std_dev_prod_9() {
		ig_md.stats_ip.std_dev_prod = hdr.peregrine.ip_std_dev_0 << 9;
	}

	action lshift_std_dev_prod_10() {
		ig_md.stats_ip.std_dev_prod = hdr.peregrine.ip_std_dev_0 << 10;
	}

	action lshift_std_dev_prod_11() {
		ig_md.stats_ip.std_dev_prod = hdr.peregrine.ip_std_dev_0 << 11;
	}

	action lshift_std_dev_prod_12() {
		ig_md.stats_ip.std_dev_prod = hdr.peregrine.ip_std_dev_0 << 12;
	}

	action lshift_std_dev_prod_13() {
		ig_md.stats_ip.std_dev_prod = hdr.peregrine.ip_std_dev_0 << 13;
	}

	action lshift_std_dev_prod_14() {
		ig_md.stats_ip.std_dev_prod = hdr.peregrine.ip_std_dev_0 << 14;
	}

	action lshift_std_dev_prod_15() {
		ig_md.stats_ip.std_dev_prod = hdr.peregrine.ip_std_dev_0 << 15;
	}
	...
	table variance_0_abs {
		...
		size = 2;
		const entries = {
			(0x80000000 &&& 0x80000000) : variance_0_neg;
			(0 &&& 0x80000000)			: variance_0_pos;
		}
	}
	...
	table variance_1_abs {
		...
		size = 2;
		const entries = {
			(0x80000000 &&& 0x80000000) : variance_1_neg;
			(0 &&& 0x80000000)			: variance_1_pos;
		}
	}
